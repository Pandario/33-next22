...
interface ModalOptFishingProps {
  active: boolean;
  setActive: (active: boolean) => void;
}

const ModalOptFishing: React.FC<ModalOptFishingProps> = ({active, setActive}) =>  {
...
<label className='flex flex-col items-center justify-center p-1'>
                    <div className="pb-2">Choose your Boat:</div>
                    <div className="">
                    <input
                          type="radio"
                          className='mr-4'
...
export default ModalOptFishing;